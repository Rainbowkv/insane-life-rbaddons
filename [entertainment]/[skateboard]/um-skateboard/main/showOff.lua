		...
		Menu[#Menu+1] = {
			...
			onSelect = function()
				if not data.skip then
					TriggerEvent("um-skateboard:Skateboard:PickPlace", data)
					Wait(1500)
				end
...
RegisterNetEvent("um-skateboard:client:showoff", showOff)
RegisterNetEvent("um-skateboard:client:holdBoard", holdBoard)