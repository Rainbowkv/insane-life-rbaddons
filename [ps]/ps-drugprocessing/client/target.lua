        ...
        options = {
            {
                ...
                action = function(entity)
                    TriggerEvent('ps-drugprocessing:pickCocaLeaves', entity)
                end
            },
        },
        distance = 4.0
        ...
        options = {
            {
                ...
                action = function(entity)
                    TriggerEvent('ps-drugprocessing:pickHeroin', entity)
                end
            },
        },
        distance = 4.0
        ...
        options = {
            {
                ...
                action = function(entity)
                    TriggerEvent('ps-drugprocessing:pickWeed', entity)
                end
            },
        },
        distance = 4.0
        ...
        options = {
            {
                ...
                action = function(entity)
                    TriggerEvent('ps-drugprocessing:pickSodium', entity)
                end
            },
        },
        distance = 4.0
        ...
        options = {
            {
                ...
                action = function(entity)
                    TriggerEvent('ps-drugprocessing:pickSulfuric', entity)
                end
            },
        },
        distance = 4.0
        ...
        options = {
            {
                ...
                action = function(entity)
                    TriggerEvent('ps-drugprocessing:pickChemicals', entity)
                end
            },
        },
        distance = 4.0
        ...
        options = {
            {
                ...
                action = function(entity)
                    TriggerEvent('ps-drugprocessing:client:hydrochloricacid', entity)
                end
            },
        },
        distance = 4.0
