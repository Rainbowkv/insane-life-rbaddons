...
(() => {
    ...
    n.n = e => {
		...
		function $t(e, t) {
    		var n = e > t ? e - t : t - e;
    		return 1 === Math.floor(n / Qt) ? "一分钟" : 1 === Math.floor(n / Vt) ? "一小时" : 1 === Math.floor(n / Wt) ? "一天" : 1 === Math.floor(n / qt) ? "一个月" : n === Bt ? "一年" : n > Bt ? Math.floor(n / Bt) + " 年" : n > qt ? Math.floor(n / qt) + " 个月" : n > Wt ? Math.floor(n / Wt) + " 天" : n > Vt ? Math.floor(n / Vt) + " 小时" : n > Qt ? Math.floor(n / Qt) + " 分钟" : n > Ht ? Math.floor(n / Ht) + " 秒" : n <= Ht ? "几秒" : void 0
		}
