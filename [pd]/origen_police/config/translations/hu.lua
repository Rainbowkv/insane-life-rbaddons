...
Translations = {
    ...
    ['camera'] = {
        ['takepick'] = 'Kép készítése', -- Csak ha origen_notify-t használsz
        ['zoom'] = 'Nagyítás/Kicsinyítés', -- Csak ha origen_notify-t használsz
        ['cancel'] = 'Mégse', -- Csak ha origen_notify-t használsz
        ['fullText'] = '%s - Kép készítése\n%s - Nagyítás\n%s - Mégse',
    },

    ['objects'] = {
        ['place'] = 'Tárgy elhelyezése', -- Csak ha origen_notify-t használsz
        ['prev'] = 'Előző tárgy', -- Csak ha origen_notify-t használsz
        ['next'] = 'Következő tárgy', -- Csak ha origen_notify-t használsz
        ['cancel'] = 'Mégse', -- Csak ha origen_notify-t használsz
