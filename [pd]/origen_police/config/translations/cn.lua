...
Translations = {
    ...
    ['camera'] = {
        ['takepick'] = '拍照', -- 仅当使用 origen_notify 时
        ['zoom'] = '缩放', -- 仅当使用 origen_notify 时
        ['cancel'] = '取消', -- 仅当使用 origen_notify 时
        ['fullText'] = '%s - 拍照\n%s - 缩放\n%s - 取消',
    },

    ['objects'] = {
        ['place'] = '放置物品', -- 仅当使用 origen_notify 时
        ['prev'] = '上一个物品', -- 仅当使用 origen_notify 时
        ['next'] = '下一个物品', -- 仅当使用 origen_notify 时
        ['cancel'] = '取消', -- 仅当使用 origen_notify 时
        ['fullText'] = '%s - 放置物品\n%s - 上一个物品\n%s - 下一个物品\n%s - 取消',
    },
    ...
    ["InvalidVehicleToConfiscate"] = "无效的车辆无法被扣押",
