...
Config.Framework = "qbcore" -- The name of the framework: auto | esx | qbcore | ...
Config.MySQLSystem = "oxmysql" -- icmysql, oxmysql
Config.Language = "cn" -- core(take the language of the core configured in the server.cfg) | en | es | fr | it | cn | hu
...
Config.HousingSystem = "auto" -- auto | default | origen_housing | qs-housing | esx_property
Config.VoiceSystem = "pma-voice" -- pma-voice, saltychat(IN DEVELOPMENT, ISSUES ARE EXPECTED, NO SUPPORT FOR THIS YET)
Config.Clothing = "fivem-appearance" -- auto(detect the resource) | illenium-appearance, qb-clothing, fivem-appearance, esx_skin, codem-appearance, tgiann-clothing, dx_clothing
Config.Phone = "lb-phone" -- auto(detect the resource) | default | qs-smartphone | qs-smartphone-pro | lb-phone | gksphone
...
Config.ShowCurrentStreet = false -- Show at the top of the screen the current street that the police is in
