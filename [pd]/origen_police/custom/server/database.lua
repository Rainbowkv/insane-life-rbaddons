if GetResourceState(Config.MySQLSystem) ~= "started" then
    print("^5[^6ORIGEN_POLICE^5] ^3MySQL system called "..Config.MySQLSystem.." is not started. Are you sure that you have configured origen_police/config/_framework.lua^0")
    return
end
...
elseif Config.MySQLSystem == "icmysql" then
    ...
    print("MySQL system called "..Config.MySQLSystem.." is not supported right now.")
end
