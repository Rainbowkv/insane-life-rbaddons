...
ADD IF NOT EXISTS `type` VARCHAR(50) NULL DEFAULT 'lspd' COLLATE 'utf8mb3_general_ci';

INSERT INTO `items` (`name`, `label`, `weight`, `rare`, `can_remove`) VALUES
	("instant_camera", "Instant camera", 0, 0, 1),
	("photo", "Photo", 0, 0, 1),
	("evidence_a", "Evidence of", 0, 0, 1),
	("evidence_az", "Evidence", 0, 0, 1),
	("evidence_b", "Vehicle evidence", 0, 0, 1),
	("evidence_n", "Impact evidence", 0, 0, 1),
	("evidence_ne", "Footprint evidence", 0, 0, 1),
	("evidence_r", "Blood evidence", 0, 0, 1),
	("evidence_ro", "Evidence", 0, 0, 1),
	("evidence_v", "Drug evidence", 0, 0, 1),
	("report_evidence", "Evidence report", 0, 0, 1),
	("k9", "K9 whistle", 0, 0, 1),
	("lspd_badge", "Police badge", 0, 0, 1),
	("bcsd_badge", "Sheriff badge", 0, 0, 1),
	("police_cad", "Police tablet", 0, 0, 1),
	("megaphone", "Megaphone", 0, 0, 1)
;
...
CREATE TABLE IF NOT EXISTS `origen_police_reports` (
	...
	`title` VARCHAR(255) NULL DEFAULT '' COLLATE 'utf8mb4_general_ci',
	`description` TEXT NULL DEFAULT '' COLLATE 'utf8mb4_general_ci',
	`author` VARCHAR(255) NOT NULL DEFAULT '' COLLATE 'utf8mb4_general_ci',
	...
	`location` VARCHAR(255) NOT NULL DEFAULT 'Sin ubicacion asignada' COLLATE 'utf8mb4_general_ci',
