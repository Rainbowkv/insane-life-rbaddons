...
!(function (A, e) {
	'object' == typeof exports && 'undefined' != typeof module
		...
		? define(e)
		: ((A = 'undefined' != typeof globalThis ? globalThis : A || self).html2canvas =
				e());
})(this, function () {
	'use strict';
	/*! *****************************************************************************
						...
						try {
							...
							switch (((n = 0), (e = s ? [2 & e[0], s.value] : e)[0])) {
								...
								default:
									if (
										!(s =
											0 < (s = o.trys).length && s[s.length - 1]) &&
										(6 === e[0] || 2 === e[0])
									) {
										o = 0;
										continue;
