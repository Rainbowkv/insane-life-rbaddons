<script>
  ...
  function getDispatchData(dispatch) {
    return [
      { icon: 'fas fa-clock', label: '时间', value: timeAgo(dispatch.time) },
      { icon: 'fas fa-user', label: '市民', value: dispatch.name },
      { icon: 'fas fa-phone', label: '电话', value: dispatch.number },
      { icon: 'fas fa-comment', label: '消息', value: dispatch.information },
      { icon: 'fas fa-map-location-dot', label: '街道', value: dispatch.street },
      { icon: 'fas fa-user', label: '性别', value: dispatch.gender },
      { icon: 'fas fa-gun', label: '自动步枪射击', value: dispatch.automaticGunFire },
      { icon: 'fas fa-gun', label: '武器', value: dispatch.weapon },
      { icon: 'fas fa-car', label: '载具', value: dispatch.vehicle },
      { icon: 'fas fa-rectangle-list', label: '车牌', value: dispatch.plate },
      { icon: 'fas fa-droplet', label: '颜色', value: dispatch.color },
      { icon: 'fas fa-car', label: '类别', value: dispatch.class },
      { icon: 'fas fa-door-open', label: '车门', value: dispatch.doors },
      { icon: 'fas fa-compass', label: '方向', value: dispatch.heading },
      { icon: 'fas fa-user-group', label: '单位', value: dispatch.units.length },
    ];
  }
</script>
