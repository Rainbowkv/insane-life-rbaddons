...
function HandleFuelConsumption(vehicle, fuelType)
    ...
    if not IsControlPressed(0, 71) then -- 71 is INPUT_VEH_ACCELERATE
        currentConsumption = Config.FuelUsage[0.1] * (Config.FuelConsumptionPerClass[GetVehicleClass(vehicle)] or 1.0) * (Config.FuelConsumptionPerFuelType[fuelType] or 1.0) / 10
    end
