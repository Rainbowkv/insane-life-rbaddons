...
function tabletProp(open)
    ...
    if not isVisible and open then
        ...
        if tabletObject == nil then
            -- tabletObject = CreateObject(GetHashKey('prop_cs_tablet'), GetEntityCoords(playerPed), 1, 1, 1)  -- 黑色主题
            tabletObject = CreateObject(GetHashKey('prop_cs_tablet_psmdt'), GetEntityCoords(playerPed), 1, 1, 1)  -- 白色主题
